...
describe('Controller Tests', function() {
    ...
    describe('Day Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockDay, MockHour, MockWeek;
        ...
        beforeEach(inject(function($injector) {
            ...
            createController = function() {
                $injector.get('$controller')("DayMySuffixDetailController", locals);
            };
        }));
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'advertiserApp:dayUpdate';
